/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/rendition-worker/wrangler.jsonc --strict-vars=false services/rendition-worker/worker-configuration.d.ts` (hash: f5e5976a0ee6228883f69314db5344d3)
