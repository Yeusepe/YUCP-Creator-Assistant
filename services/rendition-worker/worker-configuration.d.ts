/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/rendition-worker/wrangler.jsonc --strict-vars=false services/rendition-worker/worker-configuration.d.ts` (hash: 1185d7df027c6187d139d24a826ae773)
...
interface __BaseEnv_Env {
	...
	MATERIALIZER_ORIGIN_URL: string;
	MATERIALIZER_RENDITION_SHARED_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PACKAGE_DELIVERY_AUDIENCE" | "PACKAGE_INSTALL_ISSUER" | "PACKAGE_INSTALL_SIGNING_KEY_ID" | "PACKAGE_INSTALL_SIGNING_PUBLIC_KEY" | "RENDITION_RECEIPT_KEY_ID" | "RENDITION_RECEIPT_PUBLIC_KEY" | "MATERIALIZER_ORIGIN_URL" | "MATERIALIZER_RENDITION_SHARED_SECRET">> {}
}
