/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc --strict-vars=false` (hash: 445696aa30e6aeb57d2f5d08b3de3e60)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		RENDITION_RECEIPT_KEY_ID: string;
		RENDITION_RECEIPT_PUBLIC_KEY: string;
		RENDITION_S3_BUCKET: string;
		RENDITION_S3_ENDPOINT: string;
		RENDITION_S3_REGION: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PACKAGE_DELIVERY_AUDIENCE" | "PACKAGE_INSTALL_ISSUER" | "PACKAGE_INSTALL_SIGNING_KEY_ID" | "PACKAGE_INSTALL_SIGNING_PUBLIC_KEY" | "RENDITION_RECEIPT_KEY_ID" | "RENDITION_RECEIPT_PUBLIC_KEY" | "RENDITION_S3_BUCKET" | "RENDITION_S3_ENDPOINT" | "RENDITION_S3_REGION">> {}
}
