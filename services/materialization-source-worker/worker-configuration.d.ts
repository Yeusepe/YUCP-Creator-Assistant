/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/materialization-source-worker/wrangler.jsonc --strict-vars=false services/materialization-source-worker/worker-configuration.d.ts` (hash: f78516791451b4a8e4d2e856d4a75d6f)
