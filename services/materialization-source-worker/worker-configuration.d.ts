/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/materialization-source-worker/wrangler.jsonc --strict-vars=false services/materialization-source-worker/worker-configuration.d.ts` (hash: 480894860dee88c1e359bc97b84560fc)
// Runtime types generated with workerd@1.20260722.1 2026-07-24 nodejs_compat
interface __BaseEnv_Env {
	COMMON_CHUNK_PREFIX: string;
	COMMON_S3_BUCKET: string;
	COMMON_S3_ENDPOINT: string;
	COMMON_S3_REGION: string;
	DELIVERY_GRANT_ISSUER: string;
	DELIVERY_GRANT_KEY_ID: string;
	DELIVERY_GRANT_PUBLIC_KEY: string;
	MATERIALIZATION_SOURCE_AUDIENCE: string;
	METADATA_INDEX_PREFIX: string;
	METADATA_S3_BUCKET: string;
	METADATA_S3_ENDPOINT: string;
	METADATA_S3_REGION: string;
	PROTECTED_CHUNK_PREFIX: string;
	PROTECTED_S3_BUCKET: string;
	PROTECTED_S3_ENDPOINT: string;
	PROTECTED_S3_REGION: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMON_CHUNK_PREFIX" | "COMMON_S3_BUCKET" | "COMMON_S3_ENDPOINT" | "COMMON_S3_REGION" | "DELIVERY_GRANT_ISSUER" | "DELIVERY_GRANT_KEY_ID" | "DELIVERY_GRANT_PUBLIC_KEY" | "MATERIALIZATION_SOURCE_AUDIENCE" | "METADATA_INDEX_PREFIX" | "METADATA_S3_BUCKET" | "METADATA_S3_ENDPOINT" | "METADATA_S3_REGION" | "PROTECTED_CHUNK_PREFIX" | "PROTECTED_S3_BUCKET" | "PROTECTED_S3_ENDPOINT" | "PROTECTED_S3_REGION" | "STORAGE_FORMAT_VERSION">> {}
}
