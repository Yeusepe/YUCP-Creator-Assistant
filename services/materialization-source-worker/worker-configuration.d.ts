/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/materialization-source-worker/wrangler.jsonc --strict-vars=false services/materialization-source-worker/worker-configuration.d.ts` (hash: 2270b7217f91136ebb9fc628569e57e9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMON_CHUNK_PREFIX" | "DELIVERY_GRANT_ISSUER" | "DELIVERY_GRANT_KEY_ID" | "DELIVERY_GRANT_PUBLIC_KEY" | "MATERIALIZATION_SOURCE_AUDIENCE" | "METADATA_INDEX_PREFIX" | "PROTECTED_CHUNK_PREFIX" | "STORAGE_FORMAT_VERSION">> {}
}
