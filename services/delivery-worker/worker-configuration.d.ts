/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/delivery-worker/wrangler.jsonc --strict-vars=false services/delivery-worker/worker-configuration.d.ts` (hash: 7459c2b55cd1d97c5bd0245dfaee4aeb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMON_CHUNK_PREFIX" | "METADATA_INDEX_PREFIX" | "PACKAGE_DELIVERY_AUDIENCE" | "PACKAGE_INSTALL_ISSUER" | "PACKAGE_INSTALL_SIGNING_KEY_ID" | "PACKAGE_INSTALL_SIGNING_PUBLIC_KEY" | "STORAGE_FORMAT_VERSION">> {}
}
