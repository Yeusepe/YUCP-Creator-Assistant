...
// Storage access for the delivery and materialization source Workers comes from
// r2_buckets bindings in their wrangler.jsonc files, not from S3 credentials.
