...
export interface LocalEnv {
  ...
  BACKSTAGE_INGEST_SECRET?: string;
  LORE_INGEST_BASE_URL?: string;
  LORE_API_BASE_URL?: string;
  LORE_PRESIGN_HMAC_KEY?: string;
  LORE_REPO_NAMESPACE_SALT?: string;
  LORE_ACCESS_CLIENT_ID?: string;
  LORE_ACCESS_CLIENT_SECRET?: string;
  LORE_PRESIGN_DEFAULT_TTL_SECONDS?: string;
  LORE_TIMEOUT_MS?: string;
...
function loadFromEnv(): LocalEnv {
  ...
  return {
    ...
    BACKSTAGE_INGEST_SECRET: process.env.BACKSTAGE_INGEST_SECRET,
    LORE_INGEST_BASE_URL: process.env.LORE_INGEST_BASE_URL,
    LORE_API_BASE_URL: process.env.LORE_API_BASE_URL,
    LORE_PRESIGN_HMAC_KEY: process.env.LORE_PRESIGN_HMAC_KEY,
    LORE_REPO_NAMESPACE_SALT: process.env.LORE_REPO_NAMESPACE_SALT,
    LORE_ACCESS_CLIENT_ID: process.env.LORE_ACCESS_CLIENT_ID,
    LORE_ACCESS_CLIENT_SECRET: process.env.LORE_ACCESS_CLIENT_SECRET,
    LORE_PRESIGN_DEFAULT_TTL_SECONDS: process.env.LORE_PRESIGN_DEFAULT_TTL_SECONDS,
    LORE_TIMEOUT_MS: process.env.LORE_TIMEOUT_MS,
