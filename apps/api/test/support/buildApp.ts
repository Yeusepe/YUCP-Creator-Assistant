...
const MANAGED_ENV_KEYS = [
  ...
  'LORE_PRESIGN_DEFAULT_TTL_SECONDS',
  'LORE_TIMEOUT_MS',
  'DRAGONFLY_URI',
  'REDIS_URL',
  'LOG_LEVEL',
...
function buildEnv(config: BuildAppConfig): ManagedEnv {
  ...
  return {
    ...
    LORE_API_BASE_URL: 'https://lore.test',
    LORE_PRESIGN_HMAC_KEY: 'a'.repeat(64),
    LORE_REPO_NAMESPACE_SALT: 'test-repository-salt',
    LORE_ACCESS_CLIENT_ID: 'lore-client-id',
    LORE_ACCESS_CLIENT_SECRET: 'lore-client-secret',
    LORE_PRESIGN_DEFAULT_TTL_SECONDS: undefined,
    LORE_TIMEOUT_MS: undefined,
